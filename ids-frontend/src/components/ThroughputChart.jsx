...
const CustomTooltip = ({ active, payload, label }) => {
  ...
  return (
    <div className="bg-white border border-soc-border rounded-lg p-3 shadow-lg">
        ...
        {safeData.length === 0 ? (
          ...
          <ResponsiveContainer width="100%" height="100%">
            <ComposedChart data={safeData} margin={{ top: 4, right: 40, left: 0, bottom: 0 }}>
              ...
              <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f080" vertical={false} />
              ...
              <YAxis
                yAxisId="mbps"
                orientation="left"
                tick={{ fill: '#0284c7aa', fontSize: 10, fontFamily: 'JetBrains Mono' }}
                tickLine={false}
                axisLine={false}
                width={48}
                domain={[0, 'auto']}
              ...
              <YAxis
                yAxisId="pps"
                orientation="right"
                tick={{ fill: '#d97706aa', fontSize: 10, fontFamily: 'JetBrains Mono' }}
                tickLine={false}
                axisLine={false}
                width={48}
                domain={[0, 'auto']}
              ...
              <Legend
                wrapperStyle={{ fontSize: '11px', color: '#64748b', paddingTop: '8px', fontFamily: 'JetBrains Mono' }}
              />
