        ...
        >
          <defs>
            ...
            <pattern id="gridPat" width="30" height="30" patternUnits="userSpaceOnUse">
              <path d="M 30 0 L 0 0 0 30" fill="none" stroke="#e2e8f060" strokeWidth="0.5"/>
            </pattern>
          </defs>
          ...
          {NODES.map(node => {
            ...
            const lineColor = isAttack ? '#dc2626' : '#cbd5e1';
            const dotColor  = isAttack ? '#dc2626' : '#0284c7';
          ...
          {NODES.map(node => {
            const isAttack = nodeStates[node.id] === 'attack';
            const nodeColor = isAttack ? '#dc2626' : '#0284c7';
            const bgColor   = isAttack ? '#fef2f2' : '#f0f9ff';
          ...
          <g>
            ...
            <rect x={SERVER.x - 28} y={SERVER.y + 32}
              ...
              fill="#f0f9ff" stroke="#0284c744" strokeWidth="0.5"
            />
            <text x={SERVER.x} y={SERVER.y + 42}
              textAnchor="middle" fill="#0284c7aa"
              fontSize="8" fontFamily="JetBrains Mono"
            >
