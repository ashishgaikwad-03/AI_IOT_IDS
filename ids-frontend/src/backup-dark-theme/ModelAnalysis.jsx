...
const DarkTooltip = ({ active, payload, label }) => {
  ...
  return (
    <div className="bg-soc-card border border-soc-border rounded-lg p-2.5 text-xs font-mono shadow-xl">
          ...
          <div className="p-4" style={{ height: '300px' }}>
            <ResponsiveContainer width="100%" height="100%">
              <LineChart margin={{ top: 8, right: 16, left: 0, bottom: 20 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#1e3a5260" />
                <XAxis dataKey="fpr" type="number" domain={[0, 1]}
                  ...
                  axisLine={{ stroke: '#1e3a52' }} tickLine={false}
                />
                ...
                <Legend wrapperStyle={{ fontSize: 11, color: '#4d6b8a', fontFamily: 'JetBrains Mono', paddingBottom: 0 }} />
                {/* Diagonal baseline */}
                <Line data={BASELINE} dataKey="tpr" name="Random Classifier"
                  stroke="#4d6b8a" strokeDasharray="4 3" strokeWidth={1}
        ...
        <div className="p-4" style={{ height: '300px' }}>
          <ResponsiveContainer width="100%" height="100%">
            <BarChart data={METRICS} margin={{ top: 8, right: 24, left: 0, bottom: 4 }}
              barCategoryGap="15%">
              <CartesianGrid strokeDasharray="3 3" stroke="#1e3a5260" vertical={false} />
              <XAxis dataKey="class"
                tick={{ fill: '#c9d8e8', fontSize: 10, fontFamily: 'JetBrains Mono' }}
                axisLine={{ stroke: '#1e3a52' }} tickLine={false}
              ...
              />
              <Tooltip content={<DarkTooltip />} />
              <Legend wrapperStyle={{ fontSize: 11, color: '#4d6b8a', fontFamily: 'JetBrains Mono', paddingTop: 8 }} />
