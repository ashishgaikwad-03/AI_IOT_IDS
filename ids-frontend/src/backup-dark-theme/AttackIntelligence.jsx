...
function DarkTip({ active, payload }) {
  ...
  return (
    <div style={{
      background: '#0d1f2d', border: '1px solid #1e3248',
      borderRadius: 8, padding: '8px 12px', fontSize: 11,
      fontFamily: 'JetBrains Mono', color: '#c9d8e8'
    }}>
...
function ConfTip({ active, payload, label }) {
  ...
  return (
    <div style={{
      ...
      <p style={{ color: '#00d4ff', fontWeight: 700 }}>{label}</p>
              ...
              <div style={{ height: 90 }}>
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={confByType} margin={{ top: 2, right: 4, left: -20, bottom: 0 }}>
                    ...
                    <XAxis dataKey="name" tick={{ fill: '#4d6b8a', fontSize: 9, fontFamily: 'JetBrains Mono' }}
                           axisLine={false} tickLine={false} />
                    <YAxis domain={[0, 100]} tick={{ fill: '#4d6b8a', fontSize: 9, fontFamily: 'JetBrains Mono' }}
