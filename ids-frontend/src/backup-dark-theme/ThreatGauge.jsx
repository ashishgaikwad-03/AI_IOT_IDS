      ...
      <div className="flex-1 flex flex-col items-center justify-center py-2 px-4">
        ...
        <div className="relative w-48 h-48">
          <svg viewBox="0 0 200 180" className="w-full h-full overflow-visible">
            ...
            <text x={CX} y={CY + 10} textAnchor="middle"
              fill="#4d6b8a" fontSize="10" letterSpacing="3"
            >
              / 100
            </text>
            ...
            {/* Min/Max labels */}
            <text x="18" y="175" fill="#4d6b8a" fontSize="9" fontFamily="monospace">0</text>
            <text x="172" y="175" fill="#4d6b8a" fontSize="9" fontFamily="monospace">100</text>
          </svg>
        </div>
